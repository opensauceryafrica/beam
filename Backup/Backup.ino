...
void callback(char* topic, byte* payload, unsigned int length)
{
    ...
    else
    {
      ...
      display.setFont(ArialMT_Plain_10);
      display.setTextAlignment(TEXT_ALIGN_LEFT);
      display.drawString(0, 0, String(tariff));
      display.drawString(60, 0, "Tariff: " + String(tariff) + "SOL");
...
void loop() 
{
  ...
  //   // publish the average energy to topic5
  //   publishMessage(TOPIC5, strValue, true);
  //   // Reset parameters
  //   count = 0;
  //   sum_energy = 0;
  ...
  //   if (!isnan(measurement.energy)) {
  //     sum_energy += measurement.energy;
  //     count ++;
  //   }     
  // }
  // //----------------------------------
...
void displayPZEM(const MeasurementData& measurement)
{
  if (measurement.voltage != NAN) {
    display.setFont(ArialMT_Plain_10);
    display.setTextAlignment(TEXT_ALIGN_LEFT);
    display.drawString(0, 20, "Voltage: " + String(measurement.voltage) + "V");
  } 
  else {
    display.setFont(ArialMT_Plain_10);
    display.setTextAlignment(TEXT_ALIGN_LEFT);
  ...
  if (measurement.current != NAN) {
    ...
    display.setFont(ArialMT_Plain_10);
    display.setTextAlignment(TEXT_ALIGN_LEFT);
    display.drawString(0, 40, "Power: " + String(measurement.power) + "W");
    //--------------- Display energy
    display.setFont(ArialMT_Plain_10);
    display.setTextAlignment(TEXT_ALIGN_LEFT);
    display.drawString(0, 50, "Energy: " + String(measurement.energy) + "Kwh");
  } 
  else {
    display.setFont(ArialMT_Plain_10);
    display.setTextAlignment(TEXT_ALIGN_LEFT);
    display.drawString(0, 30,F("Error reading current"));
  }
  ...
  //   display.setFont(ArialMT_Plain_10);
  //   display.setTextAlignment(TEXT_ALIGN_LEFT);
  //   display.drawString(0, 40,F("Error reading power"));
  // }
  ...
  //   // display.setFont(ArialMT_Plain_10);
  //   // display.setTextAlignment(TEXT_ALIGN_LEFT);
  //   // display.drawString(0, 50,F("Error reading energy"));
  //   display.setFont(ArialMT_Plain_10);
  //   display.setTextAlignment(TEXT_ALIGN_LEFT);
  //   display.drawString(0, 50, "Energy: " + String(measurement.energy) + "Kwh");
  // }
